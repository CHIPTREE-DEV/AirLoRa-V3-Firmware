...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED_JOIN_Pin|RF_SW_CTRL1_Pin|RF_SW_CTRL2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB4 PB5 PB8 PB2
                           PB12 */
  GPIO_InitStruct.Pin = GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_8|GPIO_PIN_2
                          |GPIO_PIN_12;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = LED_JOIN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_JOIN_GPIO_Port, &GPIO_InitStruct);
